...
- **`thinktank.html`** – Analytická divize (strategické analýzy pro firmy). Má vlastní modrou variantu loga (modrý diamant + podtitul „ANALYTICKÁ DIVIZE“): og:image `images/og-thinktank.png`, v tmavé patičce inverzní varianta `images/logo-analyticka-divize-inverse.png` (bez odkazu). **V navbaru je záměrně standardní logo bootcampu** — logo v navbaru funguje jako návrat na HP celé domény, která má širší záběr než Analytická divize. Obě PNG jsou odvozená z rastru 697×325 px; až dodá grafik větší/vektorovou verzi, je vhodné je přegenerovat.
